...
| [`../../research/docs/loop.md`](../../research/docs/loop.md) | Full dedicated loop RE map (evidence) |
| [`../../research/oss-tools/NOTES.md`](../../research/oss-tools/NOTES.md) | IceCoffee / ServerTools / ecosystem |
...
Loop RE evidence: [`../../research/docs/loop.md`](../../research/docs/loop.md).
...
- Dedicated loop RE map: [`../../research/docs/loop.md`](../../research/docs/loop.md)
- NAIWAZI ServerKit reconstruction (gateway split, free AC/Bot RE): [`../../research/naiwazi/NOTES.md`](../../research/naiwazi/NOTES.md)
- ServerTools (dmustanger) admin suite, optim-relevant bits: [`../../research/7dtd-ServerTools/NOTES.md`](../../research/7dtd-ServerTools/NOTES.md)
- Open-source tools survey (IceCoffee, SphereII, CSMM, MVirus, OCB, Allocs, …): [`../../research/oss-tools/NOTES.md`](../../research/oss-tools/NOTES.md)

## Changelog

- **2026-07-16:** Optim candidates canonical file is `OPTIMIZATION_CANDIDATES.md` in this project (not under research/il).
...
- **2026-07-16:** Linked OSS tools survey notes under `research/oss-tools/NOTES.md`.
